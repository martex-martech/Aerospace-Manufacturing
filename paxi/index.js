...
// Removed previous dark mode initialization and overlay color setting to avoid redeclaration errors

// Ensure dark mode class is present on root element
if (!document.documentElement.classList.contains('tw-dark')) {
    document.documentElement.classList.add('tw-dark')
}

// Set dark mode overlay color on initial load
(function setDarkModeOverlay() {
    const videoBg = document.querySelector("#video-container-bg");
    if (videoBg) {
        videoBg.style.backgroundColor = "rgba(0, 0, 0, 0.68)"; // #000000af
    }
})();

// Removed toggleMode and theme toggling functions as per user request
